...
--
-- Name: dienstleistungsnachweis_seq; Type: SEQUENCE; Schema: leistungsverwaltung; Owner: root
--

CREATE SEQUENCE leistungsverwaltung.dienstleistungsnachweis_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE leistungsverwaltung.dienstleistungsnachweis_seq OWNER TO root;
...
COPY leistungsverwaltung.dienstleistungsnachweis (id, personentage, korrektur, leistungszeitraum, geprueft, partnervertrag, kundenvertrag, taetigkeit) FROM stdin;
-47	0.875	0	2022-01-01	f	21	1	1
\.
...
--
-- Name: dienstleistungsnachweis_seq; Type: SEQUENCE SET; Schema: leistungsverwaltung; Owner: root
--

SELECT pg_catalog.setval('leistungsverwaltung.dienstleistungsnachweis_seq', 2, true);
